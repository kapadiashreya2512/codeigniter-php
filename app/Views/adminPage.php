...
<body class="bg-gradient-primary">
  ...
  <div class="container">
    ...
    <form method="post" id="update_user" name="update_user"> 
      <input type="hidden" name="adminid" id="adminid" value="<?php echo $admin['adminid']; ?>">
      ...
      <div class="form-group">
        <button type="submit" id="btn_submit" class="btn btn-primary btn-block">Save Data</button>
      </div>
    </form>
  </div>
...
var Namespace={
    configuration:{
    updateforms:"<?php echo site_url('Crud/update');?>",
  }
}
</script>
