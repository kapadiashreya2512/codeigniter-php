      ...
      <li class="nav-item active">
        ...
        <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="<?php base_url('startbootstrap-sb-admin-2-gh-pages\buttons.php'); ?>">Buttons</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo base_url('startbootstrap-sb-admin-2-gh-pages\utilities-color.php');?>">Colors</a>
            <a class="collapse-item" href="<?php echo base_url('startbootstrap-sb-admin-2-gh-pages\utilities-border.php');?>">Borders</a>
            <a class="collapse-item" href="<?php echo base_url('startbootstrap-sb-admin-2-gh-pages\utilities-animation.php');?>">Animations</a>
            <a class="collapse-item" href="<?php echo base_url('startbootstrap-sb-admin-2-gh-pages\utilities-other.php');?>">Other</a>
          </div>
        </div>
      </li>
